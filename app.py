...
# --- 3. STYLE VISUEL (FOND STREAMLIT + LOGO REVENU) ---
st.markdown(f"""
    <style>
    /* ON UTILISE LE FOND NATIF DE STREAMLIT */
    .stApp {{
        background-color: #f0f2f6 !important; /* Le gris standard de Streamlit */
    }}

    /* LE LOGO EST DE RETOUR EN FOND (FIXÉ) */
    .logo-bg {{
        position: fixed;
        top: 50%;
        left: 50%;
        ...
        width: 80vw;
        opacity: 0.03; /* 3% d'opacité */
        z-index: 0;
        pointer-events: none;
    }}
    
    /* ON REND LES CONTENEURS TRANSPARENTS POUR VOIR LE LOGO DERRIÈRE */
...
try:
    ...
    if not df.empty:
        ...
        for _, row in df_filtre.iterrows():
            ...
            with col_txt:
                ...
                with st.expander("📖 Son Histoire & Caractère"):
    ...
    st.markdown("""
        <div class="footer-container">
            ...
            <div style="font-size:0.85em; color:#666; margin-top:15px; border-top:1px solid #ddd; padding-top:10px;">
    ...
    st.error("Lien gsheets manquant.")
